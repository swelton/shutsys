...
* Syntax: SHUTSYS                                                      *
*                                                                      *
* Function: Shutdown applications in an orderly manner                 *
*                                                                      *
* Calls: None                                                          *
*                                                                      *
* Called: Via batch job shutdown                                       *
*                                                                      *
* Created: S.Welton                                                    *
*                                                                      *
...
input_dataset = 'SHUTDOWN.DATA'                /* Input dataset       */
msgpfx = ts.rexexc                                                      
...
If ts.proc_tr = 'Y' Then Say ts.rexexc'-'sub_proc' - START'             
j.job = '//SHUT'||system  'JOB (EDV1),CLASS=G,MSGCLASS=T,'              
job = job + 1                                                           
...
/* -------------------------------------------------------------- *    
 * Open and read the dataset containing data to shutdown the      *    
...
/* -------------------------------------------------------------- *     
 * Enter the command to shutdown application                      *     
 * -------------------------------------------------------------- */    
enter_command:                                                          
...
j.job = '//*'                                                           
job = job + 1                                                           
j.job = '//STOP'||snum  'EXEC PGM=IEBGENER'                             
job = job + 1                                                           
command = Strip(command)                                                
j.job = '//SYSPRINT DD SYSOUT=*'                                        
job = job + 1                                                           
